...
**$4,000 to start ($2,500 setup + your first month), then $1,500/month.**

We build it, brand it, host it, and maintain it. The agency resells it to their own clients
under their own name. No tiers, no usage surcharges, no partner/self-serve variant.

The **$25,000 full codebase buyout** is a price anchor for live conversations only. Do not
quote it in a cold sequence, an API response, or automated email. If a buyer takes it, their
setup fee and paid license months are credited toward it.

Canonical numbers live in `config/pricing.json`. Change them there and nowhere else.
